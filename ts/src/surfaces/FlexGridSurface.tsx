...
import { ContainerPane, type RenderPrimitivePicker } from "../panes/ContainerPane";
...
interface GridActions {
  ...
  /** The picker a pane opens when it has no primitive yet; see `ContainerPane`. */
    ...
    >
      ...
      <div style={{ display: "flex", flex: "1 1 0", minHeight: 0, minWidth: 0 }}>
        <ContainerPane
          containerId={leaf.container_id}
          container={container}
          pickPrimitive={actions.pickPrimitive}
          renderPicker={actions.renderPicker}
...
export function FlexGridSurface({
   ...
   * for why the edit is a function of the current layout rather than a composed
   * body, and why writes to one layout must be serialized.
   */
  edit: (edit: LayoutEdit) => void;
