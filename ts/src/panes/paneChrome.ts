...
import { defaultPrimitiveRegistry, type PrimitiveRegistry } from "./primitives/registry";
 ...
 */
export function panePrimitive(
  container: unknown,
  registry: PrimitiveRegistry = defaultPrimitiveRegistry,
): RegisteredPrimitive | undefined {
...
export function paneTitle(
  ...
  return panePrimitive(container, registry)?.displayName ?? "Unknown contents";
}
